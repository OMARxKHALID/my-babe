...
const LetterPage = ({ onComplete }: LetterPageProps) => {
  ...
  return (
    <div
      className={`page-container flex flex-col items-center justify-center px-4 py-8 relative transition-all duration-700 ${
        revealProgress > 50 ? "text-white" : "text-foreground"
      }`}
      style={{
        background:
          revealProgress > 0
    ...
    >
      ...
      >
        <h2 className="text-3xl md:text-4xl font-serif-italic text-foreground">
          Zainab, this is for you.
        </h2>
        <p className="text-muted-foreground mt-2">
          Scratch to reveal what's inside.
        </p>
      </motion.div>
