      ...
      >
        {!answered ? (
          <>
            ...
            >
              <motion.p
                ...
                transition={{ delay: 1 }}
              >
                So, Zainab, I have one last question.
              </motion.p>
              ...
              >
                ...
                <motion.button
                  ...
                  whileHover={{
                    scale: Math.max(0.4, 0.95 - noClickCount * 0.05),
                  }}
                >
                  No
                </motion.button>
          ...
          >
            ...
            <p className="text-xl text-white/80">I love you so much.</p>
          </motion.div>
        )}
      </motion.div>
    </div>
