    ...
    >
      ...
      <AnimatePresence mode="wait">
          ...
          >
            <div className="space-y-12">
                ...
                <span
                  className={
                    isPanicking
                      ...
                      : "text-white/10 transition-colors"
                  }
                >
                  REQUIRED
                </span>
              ...
              <p className="text-3xl md:text-4xl text-white/50 font-serif-italic max-w-2xl mx-auto leading-relaxed">
                Are you{" "}
                <span className="text-white border-b-2 border-white/40 px-3 break-all transition-all duration-300">
                  {name || ""}
                </span>
                ?
              </p>
            ...
            <form
              ...
              className="relative group max-w-md mx-auto space-y-12"
            >
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-transparent border-b-2 rounded-none px-4 py-8 text-4xl text-center font-mono tracking-widest text-white focus:outline-none transition-all duration-300 ${
                    isPanicking
                      ? "border-red-600"
        ...
        {view === "restricted" && (
          ...
          >
            <h2 className="text-7xl md:text-9xl font-black text-red-600 tracking-tighter">
              LOCKED
            </h2>
            <div className="text-5xl font-mono font-bold text-white/20 italic">
              {countdown}s
            </div>
            <p className="text-white/30 text-[10px] font-mono tracking-[0.4em] uppercase">
              Security Penalty: Cool-down in progress
            </p>
          </motion.div>
        )}
