    ...
    <div className="page-container gradient-romantic flex flex-col items-center justify-center px-4 py-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(350, 40%, 90%) 0%, transparent 70%)",
          }}
      ...
      >
        ...
        >
          These flowers bloom just for you, Zainab
        </motion.p>
      </motion.div>
      ...
      >
        ...
        >
          <TulipIcon size={120} color="hsl(350, 60%, 65%)" delay={1} />
          <motion.p
          ...
          >
            Your most favorite flower. Although you have lots of favorites,
            somehow it's Zainab's trademark. Tulips always remind me of your
            warmth. Just like how the sun radiates in your eyes, ahahaha, you
            look so beautiful. Being with you feels like coming home, always.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            It's my favorite flower and I always get them from you. I actually
            don't have a particular favorite in mind, but ever since we talked,
            all I could ever think of is daisy. Also, we did say we'll always
            try for each other. As for me, I'll be welcoming new beginnings of
            me to do better. That's why I love daisies, as they also mean new
            beginnings. Every daisy from you reminds me of your thoughtfulness.
            They make me feel loved in a way that words cannot fully capture.
          </motion.p>
        </motion.div>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.05 }}
        >
          <LilyIcon size={120} color="hsl(320, 70%, 75%)" delay={2} />
          <motion.p
            className="text-lg font-serif-italic text-foreground mt-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            This is your new favorite. I kept giving them to you, as they are as
        ...
        >
          ...
          >
            ...
            inspired whenever I'm with you. Having you is the kind of luck that
      ...
      >
        <p className="text-foreground/90 font-serif-italic text-lg leading-relaxed">
          Like these flowers, my love for you grows stronger each day, blooming
          more beautiful with every moment we share.
        </p>
      </motion.div>
