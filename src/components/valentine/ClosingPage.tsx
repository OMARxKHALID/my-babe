  ...
  return (
    <div className="page-container gradient-romantic flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        >
          "u r just a babe. i hope u loved it :3."
        </motion.p>
      ...
      <motion.div
        className="absolute bottom-4 text-white/10 text-[10px] font-mono tracking-widest uppercase"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 3.5 }}
      >
        This website cleared by Omar
      </motion.div>
    </div>
  );
};
