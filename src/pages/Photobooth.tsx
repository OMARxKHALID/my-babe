...
const Photobooth = () => {
  ...
  const filters = [
    ...
    {
      name: "Cool",
      value: "brightness(0.95) hue-rotate(10deg)",
      class: "cool",
    },
    { name: "Black & White", value: "grayscale(100%)", class: "grayscale" },
    {
      name: "Romantic",
      value: "sepia(0.3) contrast(1.1) brightness(1.05)",
      class: "romantic",
    },
  ...
  const capturePhoto = useCallback(() => {
    ...
    context.filter =
      currentFilter === "none"
        ? "none"
        : filters.find((f) => f.value === currentFilter)?.value || "none";
      ...
      <div className="container max-w-6xl mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-muted-foreground font-serif-italic">
            Capture beautiful moments with fun filters and templates, Zainab!
          </p>
        </motion.div>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-elevated">
              <div className="relative bg-black rounded-lg overflow-hidden mb-6 aspect-video">
                <video
                  ...
                  style={{
                    filter:
                      currentFilter === "none"
                        ? "none"
                        : filters.find((f) => f.value === currentFilter)?.value,
                  }}
                />
                {!isCapturing && (
                ...
                {countdown > 0 && (
                  ...
                  >
                    <div className="text-9xl font-heavy text-white">
                      {countdown}
                    </div>
                  </motion.div>
                )}
                    ...
                    <img
                      ...
                      style={{
                        filter:
                          photo.filter === "none"
                            ? "none"
                            : filters.find((f) => f.value === photo.filter)
                                ?.value,
                      }}
                    />
