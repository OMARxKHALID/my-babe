        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                setCurrentLetter({ ...currentLetter, title: e.target.value })
              }
            ...
            <div className="flex gap-4 mb-4">
              <select
                ...
                onChange={(e) =>
                  setCurrentLetter({ ...currentLetter, font: e.target.value })
                }
              ...
              <select
                ...
                onChange={(e) =>
                  setCurrentLetter({ ...currentLetter, color: e.target.value })
                }
                className="px-3 py-2 rounded-lg border-2 border-primary/30 focus:border-primary focus:outline-none"
              >
                {colors.map((c) => (
            ...
            <div className="flex gap-2">
              <button onClick={saveLetter} className="flex-1 btn-romantic py-2">
